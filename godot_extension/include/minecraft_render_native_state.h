...
typedef enum MinecraftRenderDrawAttribute {
    ...
    MINECRAFT_RENDER_DRAW_ATTRIBUTE_TERRAIN_BUFFER_ID = 35,
    MINECRAFT_RENDER_DRAW_ATTRIBUTE_TERRAIN_OFFSET = 36,
    MINECRAFT_RENDER_DRAW_ATTRIBUTE_TERRAIN_LENGTH = 37,
    MINECRAFT_RENDER_DRAW_ATTRIBUTE_CHUNK_BUFFER_ID = 38,
    MINECRAFT_RENDER_DRAW_ATTRIBUTE_CHUNK_OFFSET = 39,
    MINECRAFT_RENDER_DRAW_ATTRIBUTE_CHUNK_LENGTH = 40,
    MINECRAFT_RENDER_DRAW_ATTRIBUTE_GLOBALS_BUFFER_ID = 41,
    MINECRAFT_RENDER_DRAW_ATTRIBUTE_GLOBALS_OFFSET = 42,
    MINECRAFT_RENDER_DRAW_ATTRIBUTE_GLOBALS_LENGTH = 43,
    MINECRAFT_RENDER_DRAW_ATTRIBUTE_SAMPLER2_TEXTURE_ID = 44,
    MINECRAFT_RENDER_DRAW_ATTRIBUTE_SAMPLER2_BASE_MIP = 45,
    MINECRAFT_RENDER_DRAW_ATTRIBUTE_SAMPLER2_MIN_FILTER = 46,
    MINECRAFT_RENDER_DRAW_ATTRIBUTE_SAMPLER2_MAG_FILTER = 47,
    MINECRAFT_RENDER_DRAW_ATTRIBUTE_SAMPLER2_ADDRESS_U = 48,
    MINECRAFT_RENDER_DRAW_ATTRIBUTE_SAMPLER2_ADDRESS_V = 49,
