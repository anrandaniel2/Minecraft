...
void InGameHUD::render(Shader& uiShader, int w, int h) { width=w; height=h; }

void InGameHUD::render(Shader& uiShader, int w, int h, Player& player, World& world) { width=w; height=h; }
