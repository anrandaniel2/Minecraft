...
public:
    ...
    void print_full_info() {
        UtilityFunctions::print("=== Eaglercraft 26.2 FULL Decompilation ===");
...
void initialize_eaglercraft_module(ModuleInitializationLevel p_level) {
    ...
    UtilityFunctions::print("Eaglercraft 26.2 Native C++ Port - FULL version");
    UtilityFunctions::print("Original: eaglercraft-26.2-0.6.html 75,576,620 bytes Protocol 775");
    UtilityFunctions::print("Blocks: 621 Items: 959 Entities: 82 Biomes: 65 - EVERYTHING");
}
